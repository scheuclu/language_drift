...
export const STORIES: Story[] = [
  ...
  // ---- glow stories: a whole region brightens (watch intensity, not motion) ----
  {
    ...
    words: [
      ...
      { w: "baccarat", role: "context" }, { w: "pokies", role: "context" },
      { w: "sportsbook", role: "context" }, { w: "rtp", role: "context" },
      { w: "bankroll", role: "context" }, { w: "winnings", role: "context" },
      { w: "wagers", role: "context" },
    ],
    chapters: [
      {
        year: 2014,
  ...
  },
  {
    ...
    words: [
      ...
      { w: "staking", role: "context" }, { w: "cryptocurrency", role: "context" },
      { w: "nft", role: "context" }, { w: "btc", role: "context" },
    ],
    chapters: [
      {
        year: 2014,
  ...
  },
  {
    ...
    accent: "#a0ff5d",
    kicker: "2020 →",
    title: "The supplement aisle floods in.",
    blurb:
      "cbd, gummies, keto, vape — the wellness-and-supplement SEO machine that turned a quiet medical corner of the map into an endless storefront.",
    snapYear: 2021,
    axis: ["news", "cbd"],
    words: [
      { w: "cbd", role: "hero" },
      ...
      { w: "keto", role: "hero" },
      { w: "vape", role: "hero" },
      { w: "cannabis", role: "hero" },
      { w: "hemp", role: "context" }, { w: "thc", role: "context" },
      { w: "vaping", role: "context" }, { w: "edibles", role: "context" },
      { w: "wellness", role: "context" }, { w: "collagen", role: "context" },
      { w: "detox", role: "context" }, { w: "supplements", role: "context" },
      { w: "supplement", role: "context" }, { w: "probiotics", role: "context" },
      { w: "dosage", role: "context" }, { w: "melatonin", role: "context" },
      { w: "dispensary", role: "context" },
    ],
    chapters: [
      {
        year: 2014,
        title: "A shelf in the pharmacy",
        body: "cbd, keto, gummies barely register — supplements are a niche aisle next to the real medicine.",
      },
      {
        year: 2021,
        title: "The funnel opens",
        body: "Hemp legalization meets affiliate and dropship SEO. “Best CBD gummies” pages pour in and the corner starts to glow.",
      },
      {
        year: 2025,
        title: "An endless storefront",
        body: "cbd is ~40× and gummies ~60× their 2014 rate — a permanent patch of supplement copy bolted onto the web's vocabulary.",
      },
    ],
  },
  {
    ...
    accent: "#c084ff",
    kicker: "2018 →",
    title: "Everyone became a brand.",
    blurb:
      "influencer, shopify, reels, podcast — the decade the web turned its readers into a storefront and its writers into a feed.",
    snapYear: 2020,
    axis: ["factory", "influencer"],
    words: [
      { w: "influencer", role: "hero" },
      { w: "shopify", role: "hero" },
      { w: "reels", role: "hero" },
      { w: "podcast", role: "hero" },
      { w: "esports", role: "hero" },
      { w: "influencers", role: "context" }, { w: "creators", role: "context" },
      { w: "streaming", role: "context" }, { w: "monetize", role: "context" },
      { w: "subscribers", role: "context" }, { w: "whatsapp", role: "context" },
      { w: "tinder", role: "context" }, { w: "dropshipping", role: "context" },
    ],
    chapters: [
      {
        year: 2014,
        title: "Readers and writers",
        body: "A podcast is a hobby; “influencer” is barely a word. The web is pages you read, not feeds you follow.",
      },
      {
        year: 2020,
        title: "The platform decade",
        body: "Creator tooling — Shopify, Reels, streaming — plus a pandemic shove online. The cluster lights up as everyone starts selling.",
      },
      {
        year: 2025,
        title: "A feed, not a page",
        body: "influencer, shopify and reels sit many times their 2014 rate — the web reorganized itself around creators and their stores.",
      },
    ],
  },
];
