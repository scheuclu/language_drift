...
export const STORIES: Story[] = [
  ...
  },
  {
    ...
    blurb:
      "delve, elevate, seamless, captivating — the words language models reach for. Dead flat for eight years, then the whole tight knot ignites at once.",
    snapYear: 2023,
    words: [
      { w: "delve", role: "hero" },
      { w: "elevate", role: "hero" },
      { w: "seamless", role: "hero" },
      { w: "captivating", role: "hero" },
      { w: "transformative", role: "hero" },
      { w: "impactful", role: "context" },
      { w: "immersive", role: "context" },
      { w: "fostering", role: "context" },
      { w: "meticulous", role: "context" },
      { w: "intricate", role: "context" },
    ],
    chapters: [
      {
        year: 2014,
